...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'UserSettings', fields ['coinbase_user_id']
        db.create_index(u'trader_usersettings', ['coinbase_user_id'])

        # Adding unique constraint on 'UserSettings', fields ['coinbase_user_id']
        db.create_unique(u'trader_usersettings', ['coinbase_user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserSettings', fields ['coinbase_user_id']
        db.delete_unique(u'trader_usersettings', ['coinbase_user_id'])

        # Removing index on 'UserSettings', fields ['coinbase_user_id']
        db.delete_index(u'trader_usersettings', ['coinbase_user_id'])
    ...
    models = {
        ...
        u'trader.usersettings': {
            ...
            'coinbase_user_id': ('django.db.models.fields.CharField', [], {'max_length': '64', 'unique': 'True', 'null': 'True', 'db_index': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
