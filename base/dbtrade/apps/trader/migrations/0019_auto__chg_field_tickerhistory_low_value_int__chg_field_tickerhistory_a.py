...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TickerHistory.low_value_int'
        db.alter_column(u'trader_tickerhistory', 'low_value_int', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'TickerHistory.average_value_int'
        db.alter_column(u'trader_tickerhistory', 'average_value_int', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'TickerHistory.sell_value_int'
        db.alter_column(u'trader_tickerhistory', 'sell_value_int', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'TickerHistory.mtgox_timestamp'
        db.alter_column(u'trader_tickerhistory', 'mtgox_timestamp', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'TickerHistory.buy_value_int'
        db.alter_column(u'trader_tickerhistory', 'buy_value_int', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'TickerHistory.weighted_average_value_int'
        db.alter_column(u'trader_tickerhistory', 'weighted_average_value_int', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'TickerHistory.last_value_int'
        db.alter_column(u'trader_tickerhistory', 'last_value_int', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'TickerHistory.high_value_int'
        db.alter_column(u'trader_tickerhistory', 'high_value_int', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'TickerHistory.low_value_int'
        db.alter_column(u'trader_tickerhistory', 'low_value_int', self.gf('django.db.models.fields.IntegerField')(default=None))

        # Changing field 'TickerHistory.average_value_int'
        db.alter_column(u'trader_tickerhistory', 'average_value_int', self.gf('django.db.models.fields.IntegerField')(default=None))

        # Changing field 'TickerHistory.sell_value_int'
        db.alter_column(u'trader_tickerhistory', 'sell_value_int', self.gf('django.db.models.fields.IntegerField')(default=None))

        # Changing field 'TickerHistory.mtgox_timestamp'
        db.alter_column(u'trader_tickerhistory', 'mtgox_timestamp', self.gf('django.db.models.fields.CharField')(default=None, max_length=100))

        # Changing field 'TickerHistory.buy_value_int'
        db.alter_column(u'trader_tickerhistory', 'buy_value_int', self.gf('django.db.models.fields.IntegerField')(default=None))

        # Changing field 'TickerHistory.weighted_average_value_int'
        db.alter_column(u'trader_tickerhistory', 'weighted_average_value_int', self.gf('django.db.models.fields.IntegerField')(default=None))

        # Changing field 'TickerHistory.last_value_int'
        db.alter_column(u'trader_tickerhistory', 'last_value_int', self.gf('django.db.models.fields.IntegerField')(default=None))

        # Changing field 'TickerHistory.high_value_int'
        db.alter_column(u'trader_tickerhistory', 'high_value_int', self.gf('django.db.models.fields.IntegerField')(default=None))
    ...
    models = {
        ...
        u'trader.intervalhistory': {
            'Meta': {'object_name': 'IntervalHistory'},
            'date_added': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interval': ('django.db.models.fields.CharField', [], {'max_length': '32', 'db_index': 'True'}),
            'ticker': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['trader.TickerHistory']", 'unique': 'True', 'null': 'True'})
        },
        ...
        u'trader.tickerhistory': {
            ...
            'average_value_int': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            ...
            'buy_value_int': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            ...
            'high_value_int': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_value': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '5'}),
            'last_value_int': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'low_value': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '5'}),
            'low_value_int': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'mtgox_timestamp': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
            'sell_value': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '5'}),
            'sell_value_int': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            ...
            'weighted_average_value_int': ('django.db.models.fields.IntegerField', [], {'null': 'True'})
        },
        u'trader.tradeorder': {
            'Meta': {'object_name': 'TradeOrder'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'db_index': 'True'}),
            'btc_amount': ('django.db.models.fields.DecimalField', [], {'max_digits': '18', 'decimal_places': '8'}),
            'completion_status': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True', 'db_index': 'True'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'trader.tradeorderlog': {
            ...
            'price_point': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '5'}),
