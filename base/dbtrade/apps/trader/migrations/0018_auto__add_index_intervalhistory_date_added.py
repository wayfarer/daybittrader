...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'IntervalHistory', fields ['date_added']
        db.create_index(u'trader_intervalhistory', ['date_added'])


    def backwards(self, orm):
        # Removing index on 'IntervalHistory', fields ['date_added']
        db.delete_index(u'trader_intervalhistory', ['date_added'])
