...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TradeOrder.completion_status'
        db.add_column(u'trader_tradeorder', 'completion_status',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TradeOrder.completion_status'
        db.delete_column(u'trader_tradeorder', 'completion_status')
