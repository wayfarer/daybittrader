...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TradeOrderLog'
        db.create_table(u'trader_tradeorderlog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('trade_order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['trader.TradeOrder'])),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('btc_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=8)),
            ('price_point', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=5)),
        ))
        db.send_create_signal(u'trader', ['TradeOrderLog'])

        # Adding model 'TradeOrder'
        db.create_table(u'trader_tradeorder', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('parent_trade', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['trader.TradeOrder'], null=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, null=True, db_index=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=32, db_index=True)),
            ('price_point', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=5, db_index=True)),
            ('btc_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=8)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True)),
            ('date_expire', self.gf('django.db.models.fields.DateTimeField')(db_index=True)),
        ))
        db.send_create_signal(u'trader', ['TradeOrder'])


    def backwards(self, orm):
        # Deleting model 'TradeOrderLog'
        db.delete_table(u'trader_tradeorderlog')

        # Deleting model 'TradeOrder'
        db.delete_table(u'trader_tradeorder')
