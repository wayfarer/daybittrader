...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IntervalHistory'
        db.create_table(u'trader_intervalhistory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('ticker', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['trader.TickerHistory'], unique=True, null=True)),
            ('interval', self.gf('django.db.models.fields.CharField')(max_length=32, db_index=True)),
        ))
        db.send_create_signal(u'trader', ['IntervalHistory'])


    def backwards(self, orm):
        # Deleting model 'IntervalHistory'
        db.delete_table(u'trader_intervalhistory')
