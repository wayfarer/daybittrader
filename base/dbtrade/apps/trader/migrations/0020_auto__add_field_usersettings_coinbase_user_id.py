...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserSettings.coinbase_user_id'
        db.add_column(u'trader_usersettings', 'coinbase_user_id',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserSettings.coinbase_user_id'
        db.delete_column(u'trader_usersettings', 'coinbase_user_id')
    ...
    models = {
        ...
        u'trader.usersettings': {
            ...
            'coinbase_user_id': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
