...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TradeOrderLog.price_point'
        db.alter_column(u'trader_tradeorderlog', 'price_point', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=5))

    def backwards(self, orm):

        # Changing field 'TradeOrderLog.price_point'
        db.alter_column(u'trader_tradeorderlog', 'price_point', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=12, decimal_places=5))
