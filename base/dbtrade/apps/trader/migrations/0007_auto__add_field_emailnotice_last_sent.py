...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailNotice.last_sent'
        db.add_column(u'trader_emailnotice', 'last_sent',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0), db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailNotice.last_sent'
        db.delete_column(u'trader_emailnotice', 'last_sent')
