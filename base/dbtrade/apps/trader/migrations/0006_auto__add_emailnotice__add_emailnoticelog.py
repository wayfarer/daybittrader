...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EmailNotice'
        db.create_table(u'trader_emailnotice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=254)),
            ('high_price_point', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=5, db_index=True)),
            ('low_price_point', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=5, db_index=True)),
            ('market', self.gf('django.db.models.fields.CharField')(max_length=32, db_index=True)),
            ('frequency', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('max_send', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'trader', ['EmailNotice'])

        # Adding model 'EmailNoticeLog'
        db.create_table(u'trader_emailnoticelog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email_notice', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['trader.EmailNotice'], null=True)),
            ('notice_type', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('price', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=5)),
            ('market', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
        ))
        db.send_create_signal(u'trader', ['EmailNoticeLog'])


    def backwards(self, orm):
        # Deleting model 'EmailNotice'
        db.delete_table(u'trader_emailnotice')

        # Deleting model 'EmailNoticeLog'
        db.delete_table(u'trader_emailnoticelog')
