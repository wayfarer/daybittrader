...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TickerHistory.cb_sell_value'
        db.add_column(u'trader_tickerhistory', 'cb_sell_value',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=5),
                      keep_default=False)

        # Adding field 'TickerHistory.cb_sell_value_50'
        db.add_column(u'trader_tickerhistory', 'cb_sell_value_50',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TickerHistory.cb_sell_value'
        db.delete_column(u'trader_tickerhistory', 'cb_sell_value')

        # Deleting field 'TickerHistory.cb_sell_value_50'
        db.delete_column(u'trader_tickerhistory', 'cb_sell_value_50')
